...
public class Participante extends Usuario {
     ...
     * <b> post </b> El atributo de equipo del usuario deberia ser el equipo especificado
     * @param equipo
     */
     ...
     * @param nombreEquipo Nombre del equipo de fantasia, no valida si ese nombre ya lo tiene alguien mas
     ...
     * <b> post: </b> Al equipo de fantasia del usuario se le añade el jugador y se le quita el valor de este de su presupuesto
     ...
     * <b> pre:</b> El usuario debe tener un equipo de fantasia <br>
     * <b> post: </b> Al equipo de fantasia del usuario se le quita el jugador y se le añade el valor de este de su presupuesto
